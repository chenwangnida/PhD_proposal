...
\section{PSO-based Approach Experiment Study}\label{experiment_design}
...
$\cse_{Start}=\bullet(Start,\bullet( S_1,\parallel(\bullet(S_2,\bullet(S_4,End)),\bullet(S_3,\bullet(S_4,End))))).$
\end{example}
...
%=================================================================================================== Experiments
\section{GP-based Approach Experiment Study}\label{experiment_study}
